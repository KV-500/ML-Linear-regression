...
class HOTEL_MANAGEMENT:
    def __init__(self):
        ...
        _bgcolor = '#d9d9d9'  # X11 color: 'black'
        ...
        root.title("Circketer preformans predition")
        ...
        self.Message6.configure(text='''INDEX''')
        ...
        self.Button2.configure(text='''1.CIRCKETER DATASET''')
        ...
        self.Button3.configure(text='''2.ALTER DATASET''')
        ...
        self.Button4.configure(text='''3.GRAPHS & PIE CHART''')
        ...
        self.Button5.configure(text='''4. BEST FIT LINE & PREDICT VALUES''')
        self.Button5.configure(width=566)
        self.Button5.configure(command=BP)

    

        self.Button8 = Button(self.Frame1)
        self.Button8.place(relx=0.18, rely=0.77, height=103, width=566)
        ...
        self.Button8.configure(text='''5.QUIT''')
